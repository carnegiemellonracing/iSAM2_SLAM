...
namespace cone_utils {
    ...
    Eigen::MatrixXd calc_cone_range_from_car(std::vector<gtsam::Point2> &cone_obs) {
    ...
    Eigen::MatrixXd calc_cone_bearing_from_car(std::vector<gtsam::Point2> &cone_obs) {
    ...
    std::vector<gtsam::Point2> local_to_global_frame( std::vector<gtsam::Point2> cone_obs, gtsam::Pose2 cur_pose) {
        ...
        Eigen::MatrixXd bearing = cone_utils::calc_cone_range_from_car(cone_obs);
        Eigen::MatrixXd range = cone_utils::calc_cone_bearing_from_car(cone_obs);
