...
\begin{DoxyCompactList}\small\item\em Prints the positions of the observed cones stored within the vector cone\+\_\+obs. For DEBUGGING purposes. \end{DoxyCompactList}\item 
...
Prints the positions of the observed cones stored within the vector cone\+\_\+obs. For DEBUGGING purposes. 


\begin{DoxyParams}{Parameters}
{\em cone\+\_\+obs} & A memory address to the vector containing the Point2 positions of the observed cones (You can just pass in the variable, but the type is std\+::vector$<$\+Point2$>$ \&) \\
\hline
\end{DoxyParams}
